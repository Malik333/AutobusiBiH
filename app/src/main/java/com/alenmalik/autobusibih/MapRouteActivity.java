...
public class MapRouteActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void routeActivity() {
        ...
        routeMarkers.add(mMap.addMarker(new MarkerOptions().position(new LatLng(RouteActivity.routeLatFromCIty, RouteActivity.routeLngFromCity)).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)).title(RouteActivity.fromCityString.toString())));

        routeMarkers.add(mMap.addMarker(new MarkerOptions().position(new LatLng(RouteActivity.routeLatToCIty, RouteActivity.routeLngToCity)).title(RouteActivity.toCityString.toString())));
