...
public class MedjunarodniIspisModel {
    ...
    public MedjunarodniIspisModel() {
    }

    public MedjunarodniIspisModel(String relacija, String vrijemePolaska, String dan, String duzinaPuta, String linija, String cijena, String prijevoznik, String stanica) {
